...
var ArtistComponent = (function () {
    ...
    ArtistComponent.prototype.ngOnInit = function () {
        ...
        this._route.params.map(function (params) { return params['id']; })
            ...
            _this._spotifyService.getArtist(id).subscribe(function (artist) { return _this.artist = artist; });
            _this._spotifyService.getAlbums(id).subscribe(function (albums) { return _this.albums = albums.items; });
        });
    };
